...
const DropdownMenuShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("ml-auto text-xs tracking-widest opacity-60", className)} {...props} />
)
